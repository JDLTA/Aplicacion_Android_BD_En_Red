...
public class ActivityAltas extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (cajaEdad.equals("")){
            Toast.makeText(this, "EL CAMPO EDAD SOLO PERMITE EL USO DE NUEMROS",Toast.LENGTH_LONG).show();
        }
    }
    ...
    class AgregarAlumno extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... datos) {
            ...
            AnalizadorJSON analizadorJSON = new AnalizadorJSON();
                            ...
                            //10.0.2.2
            String url = "http://176.48.14.16/web_service_http_android/altas_alumnos.php";
            String metodo = "POST";
